...
class ErrorHandling implements Exception {
  ...
  Future _handleError(DioError error) async {
    switch (error.type) {
      ...
      case DioErrorType.connectTimeout:
        errorMessage = "dio_connect_timeout".tr();
        break;
      case DioErrorType.other:
        errorMessage = "dio_cancel_other".tr();
        break;
      case DioErrorType.receiveTimeout:
        errorMessage = "dio_receive_timeout".tr();
        break;
      case DioErrorType.sendTimeout:
        errorMessage = "dio_send_timeout".tr();
        break;
  ...
  Future<void> refreshToken(DioError error) async {
    ...
    await dio.request(error.requestOptions.path, options: opts, data: error.requestOptions.data, queryParameters: error.requestOptions.queryParameters);
  }
}
